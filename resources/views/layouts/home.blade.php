        ...
        <li class="relative px-6 py-3">
          <button
            ...
            <span class="inline-flex items-center">
              <i class="ml-1 w-5 h-4 fa-lg far fa-images"></i>
              <span class="ml-4">Pages</span>
            </span>
            <i class="w-5 h-5 fas fa-sort-down"></i>
          </button>
      ...
      <ul>
        ...
        <li class="relative px-6 py-3">
          <button
            ...
            @click="togglePagesMenu" aria-haspopup="true">
            <span class="inline-flex items-center">
              <i class="ml-1 w-5 h-4 fa-lg far fa-sticky-note"></i>
              <span class="ml-4">Pages</span>
            </span>
            <i class="w-5 h-5 fas fa-sort-down"></i>
          </button>
    ...
    <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
      <div class="container flex items-center justify-between h-full px-6 mx-auto text-purple-600 dark:text-purple-300">
        ...
        <button
          ...
          aria-label="Menu">
          <i class="w-6 h-6 fa-lg fas fa-bars"></i>
        </button>
        <!-- Search input -->
      ...
      <div class="container px-6 mx-auto grid">
        ...
        <a class="flex items-center justify-between p-4 mb-8 text-sm font-semibold text-purple-100 bg-purple-600 rounded-lg shadow-md focus:outline-none focus:shadow-outline-purple" href="#">
          <div class="flex items-center">
            <i class="w-4 h-4 fa fa-star mr-2"></i>
